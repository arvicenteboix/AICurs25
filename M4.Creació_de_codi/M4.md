...
Estem parlant de la creació de codi. En aquest modul anem a utilitzar diferents llenguatges de programació
...
Per a realitzat aquesta aplicació hem de conèixer en quin sistema operatiu anem a crear-lo ja que no només ens farà falta el codi sino com executar-lo. Per a aquest fi utilitzarem únicament Copilot ja que és la que, en principi funciona millor per a programar.
...
Programar pot acabar resultant una tasca veritablement estesant.
:::
...
Li donem a Accept i polsem el botó Run vert que hi ha dalt de tot. Ens apareixerà una pantalla com aquesta, on polsarem la següent tecla per a fer-la més gran:
