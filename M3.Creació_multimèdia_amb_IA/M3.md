...
[ComfyUI](https://comfyui.com/) és una eina que ens permet crear una interfície d'usuari per a qualsevol aplicació o pàgina web. És una eina molt interessant per a crear una interfície d'usuari atractiva i fàcil d'utilitzar.
